 ...
 */
export function estimateMaterials(houseAreaSqFt, _floors, quality, prices) {
 ...
 */
export function totalMaterialCost(breakdown) {
    return breakdown.reduce((sum, item) => sum + item.totalInr, 0);
}
//# sourceMappingURL=costestimator.materials.js.map