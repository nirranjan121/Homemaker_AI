...
const FLOOR_PLAN_SCHEMA: Schema = {
...
function buildPrompt(width_px: number, height_px: number): string {
...
export async function analyzeFloorPlan(image_b64: string, width_px: number, height_px: number, mime_type: string = "image/jpeg"): Promise<any> {
